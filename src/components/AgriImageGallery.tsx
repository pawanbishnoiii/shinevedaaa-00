...
interface GalleryImage {
  ...
  alt: string;
  title: string;
  category: 'farmers' | 'crops' | 'processing' | 'community';
  description: string;
}
...
const galleryImages: GalleryImage[] = [
  {
    ...
    title: 'Farmer Family Partnership',
    category: 'farmers',
    description: 'Working directly with farming families in Rajasthan for sustainable agriculture'
  },
  {
    id: '2',
    src: '/data/img/sikar-onion-harvest.jpg',
    alt: 'Sikar onion harvest — export grade onions',
    title: 'Premium Onion Harvest',
    category: 'crops',
    description: 'Export-quality onions from Sikar district, carefully graded and sorted'
  },
  {
    id: '3',
    src: '/data/img/sikar-jeera-seeds.jpg',
    alt: 'Sikar jeera seeds closeup — premium cumin',
    title: 'Premium Cumin Seeds',
    category: 'crops',
    description: 'High-oil content jeera from Sikar, known for superior aroma and quality'
  },
  {
    id: '4',
    src: '/data/img/guar-gum-processing.jpg',
    alt: 'Guar gum processing — export quality',
    title: 'Guar Gum Processing',
    category: 'processing',
    description: 'State-of-the-art processing facilities for food-grade guar gum'
  },
  {
    id: '5',
    src: '/data/img/packaging-grading.jpg',
    alt: 'Packaging and grading for exports — ShineVeda',
    title: 'Export Packaging',
    category: 'processing',
    description: 'Professional packaging and grading facilities meeting international standards'
  },
  {
    id: '6',
    src: '/data/img/farmer-training.jpg',
    alt: 'Farmer training session — small land yield improvement',
    title: 'Farmer Training Programs',
    category: 'community',
    description: 'Technical training sessions for yield improvement and modern farming techniques'
  },
  {
    id: '7',
    src: '/data/img/women-farmers-cooperative.jpg',
    alt: 'Women farmers cooperative — Rajasthan',
    title: 'Women Farmers Cooperative',
    category: 'community',
    description: 'Supporting women-led farming cooperatives across rural Rajasthan'
  },
  {
    id: '8',
    src: '/data/img/punjab-farmer-portrait.jpg',
    alt: 'Punjab farmer portrait — diversified crops',
    title: 'Punjab Partnership',
    category: 'farmers',
    description: 'Expanding partnerships with progressive farmers in Punjab'
  }
];
...
const AgriImageGallery: React.FC = () => {
...
export default AgriImageGallery;